...
CREATE TABLE `train_schedule` (
  `schedue_id` bigint NOT NULL AUTO_INCREMENT,
  `train_no` bigint NOT NULL,
  `train_name` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
  `train_start_time` time DEFAULT NULL,
  `train_reach_time` time DEFAULT NULL,
  `running_status` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL,
...
INSERT INTO `train_schedule` VALUES (1,1001,'NELLAI EXPRESS','06:00:00','23:00:00','ONLINE','TIRUNEVELI','CHENNAI'),(2,1002,'CHEENAI EGMORE EXPRESS','05:00:00','20:00:00','ONLINE','CHENNAI','TIRUNELVELI');
...
-- Dump completed on 2023-12-19 17:33:40
